...
int main(){
	...
	for (int i = 0; i < n; ++i){
		...
		if ((x % 2) == 1){
			...
			sum1 += y;
			sum0 += x;
			if ( ((x % 2) == 1) && ((y % 2) == 1) && ((x + y) < min>
                                min1 = x + y;
                        if ( ((x % 2) == 0) && ((y % 2) == 1) && ((x + y) < min>
                                min2 = x + y;
                        if ( ((x % 2) == 1) && ((y % 2) == 0) && ((x + y) < min>
                                min3 = x + y;
	...
	if ( (sum0 % 2 == 0) && (sum1 % 2 == 1)
		...
		if ( min1 < (min2 + min3))
			printf("%d", sum0 + sum1 - min1);
		else
			printf("%d", sum0 + sum1 - min2 - min3);
	else if ( (sum0 % 2 == 1) && (sum1 % 2 == 1))
                if ( min2 < (min1 + min3))
                        printf("%d", sum0 + sum1 - min2);
                else
                        printf("%d", sum0 + sum1 - min1 - min3);
	else if ( (sum0 % 2 == 0) && (sum1 % 2 == 0))
                if ( min3 < (min1 + min2))
                        printf("%d", sum0 + sum1 - min3);
                else
                        printf("%d", sum0 + sum1 - min1 - min2);
}
